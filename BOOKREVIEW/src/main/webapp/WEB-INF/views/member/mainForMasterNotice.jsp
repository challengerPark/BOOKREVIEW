...
<head>
  ...
  <link href=resources/css/adminNotice.css rel="stylesheet">
            ...
            <div class="innerwrap">
                ...
                <div id="article1">
                    ...
                    <div id="article1-1">
                        ...
                        <div id="article1-1-2" class="adminmenu menu2">
                        ...
                        <div id="article1-1-3" class="adminmenu menu1">
							...
							<div id="article1-2-table">
										...
										<div class="modal-dialog modal-dialog-centered">
											<div class="modal-content">
												<div class="modal-header">
													<p class='fontstyle8' id="#noticeInsert">공지사항 추가</p>
												</div>
												...
												<div class="modal-footer">
													<button onmouseover="this.style.color='#33d1ea';" onmouseout="this.style.color='#000';" type="button" style="color:#000;" id="modal_Close"
														class="btn btn-secondary" data-bs-dismiss="modal">닫기</button>
													<button  onmouseover="this.style.color='#33d1ea';" onmouseout="this.style.color='#000';" type="button"  style="color:#000;" id="sendNotice"
								...
								<c:forEach items="${noList}" var="n">
                                    <div class="article1-2-table-2 clickDiv">
                                            <p style="display:none" class="fontstyle10 noticeNo">${n.noticeNo }</p>
                                      
                                       
                                        <div>
                                             <label for='noticeList${n.noticeNo }'>
                                       ...
                                       <label for='noticeList${n.noticeNo }'>
                                        ...
                                        <div>
                                       <label for='noticeList${n.noticeNo }'>
                                            <p class="fontstyle10">${n.noticeContent }</p>
                                            </label>
                                        </div>
                                        <div>
                                        <label for='noticeList${n.noticeNo }'>
                                            <p class="fontstyle10"><fmt:formatDate pattern="yyyy-MM-dd" value="${n.createDate}" /></p>
                                            </label>
                                        </div>
                                         <input id='noticeList${n.noticeNo }' type="checkbox" name="noticeChecker"  class="checkedTeacher">
                                    </div>
                                    </c:forEach>
